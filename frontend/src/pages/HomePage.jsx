...
const HomePage = () => {
  ...
  return (
    <div className="flex h-screen">
      {/* Sidebar */}
      <div className="w-64 bg-gray-800 text-white rounded-lg shadow-lg h-full flex-shrink-0 p-4 transition-transform duration-700 ease-in-out transform translate-x-0 opacity-100">
        <h2 className="text-2xl font-bold mb-4 animate-slide-left">Sidebar</h2>
        <ul>
          <li className="mb-2">
            <a href="#" className="hover:bg-gray-700 p-2 block transition-all duration-300 transform hover:translate-x-2">
              Link 1
            </a>
          </li>
          <li className="mb-2">
      ...
      <div className="flex-1 h-full bg-gray-100 p-4 flex items-center justify-center">
        {/* Banner Section */}
        <div className="bg-white w-full max-w-6xl rounded-lg shadow-lg flex h-screen animate-fade-in">
          {/* Left Side (Text Content) */}
          <div className="w-1/2 p-8 flex flex-col justify-center transition-opacity duration-700 ease-in-out opacity-100">
            <div className="mb-4">
              ...
              <p className="text-lg text-gray-700 mb-6 animate-fade-in-down">Best healthcare for your family</p>
            </div>
          ...
          <div className="w-1/2 h-full">
            <img src="/image.png" alt="Doctors" className="object-cover w-full h-full animate-fade-in-right" />
          </div>
        </div>
      </div>
    </div>
